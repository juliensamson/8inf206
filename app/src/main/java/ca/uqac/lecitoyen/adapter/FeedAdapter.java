...
public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.ViewHolder> {
    ...
    public FeedAdapter(Context context, FirebaseUser currentUser, ArrayList<Post> postList, ArrayList<User> userList) {
    ...
    public void onBindViewHolder(@NonNull final FeedAdapter.ViewHolder holder, final int position) {
        ...
        final User currUser = getUserDataFromPost(currPost);
