...
public class ProfilTestFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_profil_test, container, false);

        Log.d(TAG, "onCreateView");
        //  Handle toolbar
        toolbar = view.findViewById(R.id.toolbar_profil);
        ((AppCompatActivity) userMainActivity).setSupportActionBar(toolbar);
        ...
        mLayoutManager = new LinearLayoutManager(userMainActivity);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.menu_setting:
                ...
                startActivity(new Intent(userMainActivity.getApplicationContext(), UserSettingsActivity.class ));
                return true;
        }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(userData != null)
                {
                    if(userData.getPid() != null && !userData.getPid().isEmpty()) {
                        Glide.with(userMainActivity).load(stUserProfilPicture.child(userData.getPid())).into(mToolbarProfilPictureView);
                        Glide.with(userMainActivity).load(stUserProfilPicture.child(userData.getPid())).into(mProfilPictureView);
                    }
