 ...
 * {@link DoSearchFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DoSearchFragment#newInstance} factory method to
...
public class DoSearchFragment extends Fragment {
    ...
    public static DoSearchFragment newInstance(User userAuth, ArrayList<User> users) {
        DoSearchFragment fragment = new DoSearchFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_do_search, container, false);
    }
