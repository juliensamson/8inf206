...
public class ScrollingFabMenuBehavior extends CoordinatorLayout.Behavior<FloatingActionMenu> {

    private int toolbarHeight;

    public ScrollingFabMenuBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
